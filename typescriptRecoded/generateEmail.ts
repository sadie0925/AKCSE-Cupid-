...
export function generateEmails(matchedCouples: Array<Array<Array<String>>>, unmatchedIndividuals: Array<Array<String>>) {
    ...
    matchedCouples.forEach((match, index) => {
        ...
        successString +=    "====== Send to:   " + firstPerson[qi.email] + "  =======\n\n";
        successString += "Congratulations! \n\nWe found your perfect match!\nBased on your preferences and personality traits, our unique Cupid’s Algorithm has matched you with "+ secondPerson[qi.name] + ".\nNow, it is your turn to shoot the arrow and write the next chapter of your life.\nAll members of AKCSE wish you good luck.\nYour match’s IG handle is @" + secondPerson[qi.ig] + ". \nSo what are you waiting for? Shoot your shot!\n\nAKCSE UW";
        successString += "\n\n축하합니다, 신청자분의 “천생연분”을 찾았습니다!\n개인의 취향과 성향을 바탕으로 만든 악세의 Cupid’s Algorithm이 신청자분을" + secondPerson[qi.name] + "님과 연결 시켰다고 합니다.\n매치 된 상대방의 인스타그램 아이디는 @" + secondPerson[qi.ig] + " 입니다.\n주저하지 말고 신청자분의 큐피드 화살로 천생연분을 잡으세요!\n저희 모든 악세 임원들이 응원합니다 :)\n\n악세 드림"
        successString += marketingString

        successString +=    "\n\n====== Send to:   " + secondPerson[qi.email] + "  =======\n\n";
        successString += "Congratulations! \n\nWe found your perfect match!\nBased on your preferences and personality traits, our unique Cupid’s Algorithm has matched you with "+ firstPerson[qi.name] + ".\nNow, it is your turn to shoot the arrow and write the next chapter of your life.\nAll members of AKCSE wish you good luck.\nYour match’s IG handle is @" + firstPerson[qi.ig] + ". \nSo what are you waiting for? Shoot your shot!\n\nAKCSE UW";
        successString += "\n\n축하합니다, 신청자분의 “천생연분”을 찾았습니다!\n개인의 취향과 성향을 바탕으로 만든 악세의 Cupid’s Algorithm이 신청자분을" + firstPerson[qi.name] + "님과 연결 시켰다고 합니다.\n매치 된 상대방의 인스타그램 아이디는 @" + firstPerson[qi.ig] + " 입니다.\n주저하지 말고 신청자분의 큐피드 화살로 천생연분을 잡으세요!\n저희 모든 악세 임원들이 응원합니다 :)\n\n악세 드림"
        successString += marketingString
